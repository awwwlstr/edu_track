...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <img src="<?php echo e(asset('images/login.png')); ?>" alt="Logo">
            <h3>EDU-TRACK</h3>
...
unset($__errorArgs, $__bag); ?>" 
                                   placeholder="Masukkan email" value="<?php echo e(old('email')); ?>" required autofocus>
                        </div>
...
</html><?php /**PATH C:\laragon\www\edu_track\resources\views/auth/login.blade.php ENDPATH**/ ?>