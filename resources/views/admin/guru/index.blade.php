        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($item->foto)
                            <img src="{{ asset('storage/profil/' . $item->foto) }}"
                                 ...
                                 alt="Foto"
                                 onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name={{ urlencode($item->nama) }}&size=40&background=10b981&color=fff'">
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode($item->nama) }}&size=40&background=10b981&color=fff"
                                 class="rounded-circle"
                    ...
                    <td>
                        <span style="font-weight:600;font-size:0.875rem;">{{ $item->nama }}</span>
                    </td>
                    <td>
                    ...
                    <td>
                        <span style="font-size:0.875rem;color:var(--text-muted);">{{ $item->email }}</span>
                    </td>
                    <td>
                        <div class="d-flex gap-2">
                            <a href="/admin/guru/{{ $item->id_user }}/edit"
                            ...
                            <form action="/admin/guru/{{ $item->id_user }}" method="POST"
                                  class="d-inline"
